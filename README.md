...
What is left to do now:
  ...
  * Cosmetic changes to vizzes: Add color to the automaker plot, add a fade effect to the vizzes for when the filter is active, add a title to the Stats Scatter plot
